...
#
# Generated by export_simulation on Tue Jul 21 17:11:43 -0400 2020
#
################################################################################
...
'-reset_run' switch to the './demod_mult.sh' script.

./demod_mult.sh -reset_run
...
./demod_mult.sh -noclean_files

For more information on the script, please type './demod_mult.sh -help'.
