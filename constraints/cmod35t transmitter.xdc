...
#create_generated_clock -name base_clk -source [get_pins clk_MCMM/inst/mmcm_adv_inst/CLKOUT0] -master_clock [get_clocks clk_MCMM/inst/clk_in1] [get_clocks clk_out_base_clk_base];
