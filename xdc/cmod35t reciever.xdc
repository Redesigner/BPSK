...
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { wave[0]  }]; #IO_L6P_T0_16 Sch=pio[09]
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { wave[1] }]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { wave[2] }]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { wave[3] }]; #IO_L5P_T0_AD13P_35 Sch=pio[12]
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { wave[4] }]; #IO_L6N_T0_VREF_35 Sch=pio[13]
set_property -dict { PACKAGE_PIN L2    IOSTANDARD LVCMOS33 } [get_ports { wave[5] }]; #IO_L5N_T0_AD13N_35 Sch=pio[14]

set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { wave[6] }]; #IO_L1P_T0_AD4P_35 Sch=ain_p[15]
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { wave[7] }]; #IO_L2P_T0_AD12P_35 Sch=ain_p[16]

set_property -dict { PACKAGE_PIN M1    IOSTANDARD LVCMOS33 } [get_ports { wave[8] }]; #IO_L9N_T1_DQS_AD7N_35 Sch=pio[17]
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { wave[9] }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]
