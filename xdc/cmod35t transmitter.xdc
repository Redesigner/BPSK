...
create_clock -add -name sysclk_pin -period 83.33 -waveform {0 41.66} [get_ports {sysclk}];
...
set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports { debug }]; #IO_L12N_T1_MRCC_35 Sch=pio[19]
...
set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports { clk_out }]; #IO_L19N_T3_VREF_35 Sch=pio[23]
set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports { sleep }]; #IO_L2P_T0_34 Sch=pio[26]
...
set_property -dict { PACKAGE_PIN V3    IOSTANDARD LVCMOS33 } [get_ports { wave[0] }]; #IO_L6P_T0_34 Sch=pio[35]
set_property -dict { PACKAGE_PIN W5    IOSTANDARD LVCMOS33 } [get_ports { wave[1] }]; #IO_L12P_T1_MRCC_34 Sch=pio[36]
set_property -dict { PACKAGE_PIN V4    IOSTANDARD LVCMOS33 } [get_ports { wave[2] }]; #IO_L11N_T1_SRCC_34 Sch=pio[37]
set_property -dict { PACKAGE_PIN U4    IOSTANDARD LVCMOS33 } [get_ports { wave[3] }]; #IO_L11P_T1_SRCC_34 Sch=pio[38]
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { wave[4] }]; #IO_L16N_T2_34 Sch=pio[39]
set_property -dict { PACKAGE_PIN W4    IOSTANDARD LVCMOS33 } [get_ports { wave[5] }]; #IO_L12N_T1_MRCC_34 Sch=pio[40]
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { wave[6] }]; #IO_L16P_T2_34 Sch=pio[41]
set_property -dict { PACKAGE_PIN U2    IOSTANDARD LVCMOS33 } [get_ports { wave[7] }]; #IO_L9N_T1_DQS_34 Sch=pio[42]
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { wave[8] }]; #IO_L13N_T2_MRCC_34 Sch=pio[43]
set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { wave[9] }]; #IO_L9P_T1_DQS_34 Sch=pio[44]
